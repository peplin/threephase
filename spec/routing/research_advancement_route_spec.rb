...
describe "routing to research_advancements" do
  it { {:get, "/game/1/research_advancements"}.should route_to(
      :action => :index, :game => 1, :controller => "research_advancements") }

  it { {:get, "/game/1/research_advancement/2"}.should route_to(
      :action => :show, :game => 1, :id => 2,
      :controller => "research_advancements") }

  it { {:post, "/game/1/research_advancements"}.should route_to(
      :action => :create, :game => 1, :controller => "research_advancements") }
