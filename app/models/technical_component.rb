class TechnicalComponent < ActiveRecord::Base
  ...
  attr_accessible :name, :capacity, :mtbf, :mttr, :repair_cost, :workforce,
      :area, :capital_cost_min, :capital_cost_max,
      :environmental_disruptiveness, :waste_disposal_cost_min,
      :waste_disposal_cost_max, :noise, :lifetime, :buildable, :user
